...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-primary">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data["count_user"] }}</div>
                <div>Pengguna</div>
                <small class="text-medium-emphasis-inverse">Jumlah Pengguna Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-warning">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data["count_criteria"] }}</div>
                <div>Kriteria</div>
                <small class="text-medium-emphasis-inverse">Jumlah Kriteria Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-danger">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data['count_weight'] }}</div>
                <div>Bobot</div>
                <small class="text-medium-emphasis-inverse">Jumlah Bobot Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-info">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data['count_team'] }}</div>
                <div>Tim</div>
                <small class="text-medium-emphasis-inverse">Jumlah Tim Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-danger">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data['count_jury'] }}</div>
                <div>Juri</div>
                <small class="text-medium-emphasis-inverse">Jumlah Juri Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-info">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{ $data['count_calculation'] }}</div>
                <div>Perhitungan</div>
                <small class="text-medium-emphasis-inverse">Jumlah Perhitungan Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
